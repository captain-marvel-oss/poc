...
@CucumberOptions(features = "Features/", glue = { "e2e.tests.stepdef" }, tags = {
        "@smoke, @regression" }, strict = true, monochrome = true, plugin = { "pretty",
...
public class BddTests extends BddTestNG {
    ...
    public void Demo(Map<String, String> driverDetails, Map<String, String> data, PickleEventWrapper pickleEvent,
        ...
        try {
            ...
            for (PickleStep i : pickleEvent.getPickleEvent().pickle.getSteps()) {
                System.out.println("PICKLE STEP: \t" + i.getText());
            }
